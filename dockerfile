...
COPY ./package.json /usr/src/app/trackinops-crawler/package.json
...
CMD NODE_ENV=production readTopic='trackinops.crawler.001' node --max_old_space_size=4096 index.js